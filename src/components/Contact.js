        ...
        <div className="contact-content">
          <div className="contact__details">
            ...
            <div className="contact__list">
              ...
              <p>
                <a href="https://github.com/nandha-techie" target="__blank">
                  github.com/nandha-techie
                </a>
              </p>
            </div>
          </div>
          <div className="aboutMe">
            ...
            <div className="aboutMe__details">
              ...
              <p>
                A Frontend Developer with a comprehensive understanding of DOM.
                From translating design mockups into UI interactive pages, I
